...
```{r}
work2004 <- da04572.0002 %>% select("V1057", "V0014","V0018","V0029","V0030","V0031","V0032","V0033", "V0034", "V0059", "V0058", "V1740", "V1857","V2272", "V2273","V2386", "V2387", "V2388", "V2392", "V2394", "V2395")
work2016 <- da37692.0002 %>% select("V0772", "RV0002","RV0003", "RV0008", "RV0051", "RV0054", "V1145", "V1201", "V1202", "V1179", "V1180", "V1181", "V1182", "V1183", "V1184")
```
...
```{r}
mergeCali2004 <- workCali2004 %>% select("V1057","Race","AgeCat","Marriage", "Schooling", "MentalHealthScoreLeniant", "MentalHealthScoreStrict", "Year", "treatment")
mergeCont2004 <- workCont2004 %>% select("V1057","Race","AgeCat","Marriage", "Schooling", "MentalHealthScoreLeniant", "MentalHealthScoreStrict", "Year", "treatment")
mergeCont2016 <- workCont2016 %>% select("V0772","RV0003","RV0002","RV0051", "RV0054", "MentalHealthScoreLeniant", "MentalHealthScoreStrict", "Year", "treatment")
colnames(mergeCont2016) <- c("V1057","Race","AgeCat","Marriage", "Schooling", "MentalHealthScoreLeniant", "MentalHealthScoreStrict", "Year", "treatment")
mergeCali2016 <- workCali2016 %>% select("V0772","RV0003","RV0002","RV0051", "RV0054", "MentalHealthScoreLeniant", "MentalHealthScoreStrict", "Year", "treatment")
colnames(mergeCali2016) <- c("V1057","Race","AgeCat","Marriage", "Schooling", "MentalHealthScoreLeniant", "MentalHealthScoreStrict", "Year", "treatment")
```
...
lm(MentalHealthScoreLeniant~Year + treatment +Year*treatment + Race + Schooling + AgeCat + Marriage, MergedSurvey) %>% summary()
```
