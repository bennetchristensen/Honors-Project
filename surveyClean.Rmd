...
work2004 <-work2004 %>% mutate(MentalHealthScore = NervousBin + HopelessBin + RestlessBin + DepressBin + EffortBin + WorthlessBin  
)
```
...
work2016 <-work2016 %>% mutate(MentalHealthScore = NervousBin + HopelessBin + RestlessBin + DepressBin + EffortBin + WorthlessBin  
)
```
...
```
```{r}
MentalChart<-cbind((workCont2016 %>% count(MentalHealthScore))[1],
(workCont2004 %>% count(MentalHealthScore))[2],
(workCont2016 %>% count(MentalHealthScore))[2],
(workCali2004 %>% count(MentalHealthScore))[2],
(workCali2016 %>% count(MentalHealthScore))[2]
)
colnames(MentalChart)[2:5] <- c("2004 Control", "2016 Control","2004 California", "2016 California")
MentalChart
MentalChartPerc<-cbind((workCont2016 %>% count(MentalHealthScore))[1],
(workCont2004 %>% count(MentalHealthScore))[2]/2835,
(workCont2016 %>% count(MentalHealthScore))[2]/3442,
(workCali2004 %>% count(MentalHealthScore))[2]/1757,
(workCali2016 %>% count(MentalHealthScore))[2]/1375
)
